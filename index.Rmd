...
It is important to note that while the effects of ethnolinguistic fractionalism remain statistically significant even after testing other confounding variables, such as the presence of government crises, riots or revolutions, it is not to say that thus relationship is causal. 

We do not have enough information on the nature of the constitutional change, and whether it actually concerned ethnic fractionalism through means such as government quota systems etc.A confounding variable not explored in this dataset, is whether countries were colonised, which is a important indicator for constitutional change. 
...
A quick look at this list complied of the countries which experienced constitutional change can tell us that virtually all of these countries have been formerly colonised.



## Conclusion

While there is evidence to support my hypothesis and there appears to be a positive correlation between ethnolinguistic fractionalism and constitutional change, I believe that there are many other possible confounding variables which could play a role (e.g. colonial status,) and I would in the future hope to explore these. I would also hope to use a larger sample size of countries, and examine them over a longer time period. 
